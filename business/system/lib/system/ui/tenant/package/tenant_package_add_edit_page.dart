          ...
          return PopScope(
              ...
              child: Scaffold(
                  appBar: AppBar(
                    ...
                    actions: [
                      if ((UserShareVm().hasPermiAny(["system:tenantPackage:edit"]) &&
                              sysTenantPackage != null) ||
                          (UserShareVm().hasPermiAny(["system:tenantPackage:add"]) &&
                              sysTenantPackage == null))
                        IconButton(
                            onPressed: () {
                              getVm().onSave();
                      ...
                      if (sysTenantPackage != null &&
                          UserShareVm().hasPermiAny(["system:tenantPackage:remove"]))
...
class _TenantPackageAddEditVm extends AppBaseVm with CancelTokenAssist {
  ...
  void initVm({SysTenantPackage? sysTenantPackage}) {
    ...
    if (sysTenantPackage == null) {
      sysTenantPackage = SysTenantPackage();
      ITreeDict<dynamic>? menuCheckStrictlyDict = DictShareVm()
