...
import 'dept_add_edit_page.dart';
      ...
      builder: (context, child) {
        ...
        return PopScope(
            ...
            child: Scaffold(
                ...
                //图标滚动使用固定大小来解决
                floatingActionButton: UserShareVm().widgetWithPermiAny(["system:dept:add"], () {
  ...
  _DeptListBrowserVm() {
    ...
    listVmSub.onSuffixClick = (DeptTree data) {
      pushNamed(DeptAddEditPage.routeName,
              arguments: {ConstantUser.KEY_DEPT: Dept(deptId: data.id, deptName: data.label)})
          .then((value) {
        if (value != null) {
