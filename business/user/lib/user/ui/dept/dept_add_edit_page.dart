        ...
        return PopScope(
            ...
            child: Scaffold(
                appBar: AppBar(
                    ...
                    actions: [
                      if ((UserShareVm().hasPermiAny(["system:dept:edit"]) && deptInfo != null) ||
                          (UserShareVm().hasPermiAny(["system:dept:add"]) && deptInfo == null))
                        IconButton(
                            onPressed: () {
                              getVm().onSave();
                            },
                            icon: Icon(Icons.save)),
                      if (deptInfo != null && UserShareVm().hasPermiAny(["system:dept:remove"]))
