                ...
                children: [
                  ...
                  MyFormBuilderTextField(
                      ...
                      decoration: MyInputDecoration(
                          ...
                          labelText: S.current.dict_label_data_label,
                  ...
                  FormBuilderTextField(
                      name: "dictValue",
                      initialValue: listVmSub.currentSearch.dictValue,
                      decoration: MyInputDecoration(
                          contentPadding: EdgeInsets.zero,
                          floatingLabelBehavior: FloatingLabelBehavior.always,
                          labelText: S.current.dict_label_data_value,
                          hintText: S.current.app_label_please_input,
                          border: const UnderlineInputBorder(),
                          suffixIcon: NqNullSelector<A, String?>(
                              builder: (context, value, child) {
                            return InputDecUtils.autoClearSuffixByInputVal(
                                value,
                                formOperate: listVmSub.formOperate,
                                formFieldName: "dictValue");
                          }, selector: (context, vm) {
                            return listVmSub.currentSearch.dictValue;
                          })),
                      onChanged: (value) {
                        listVmSub.currentSearch.dictValue = value;
                        listVmSub.notifyListeners();
                      },
                      textInputAction: TextInputAction.next),
                  SlcStyles.getSizedBox(height: SlcDimens.appDimens16),
