              ...
              child: Scaffold(
                  appBar: AppBar(
                    title: Text(dictData == null
                        ? S.current.dict_label_dict_data_add
                        : S.current.dict_label_dict_data_edit),
                    actions: [
                      IconButton(
                          onPressed: () {
                            getVm().onSave();
                  ...
                  children: [
                    ...
                    MyFormBuilderTextField(
                        ...
                        decoration: MyInputDecoration(
                            floatingLabelBehavior: FloatingLabelBehavior.always,
                            label: InputDecUtils.getRequiredLabel(
                                S.current.dict_label_data_label),
                            hintText: S.current.app_label_please_input,
                            border: const UnderlineInputBorder()),
                        onChanged: (value) {
                    ...
                    MyFormBuilderTextField(
                        ...
                        decoration: MyInputDecoration(
                            floatingLabelBehavior: FloatingLabelBehavior.always,
                            label: InputDecUtils.getRequiredLabel(
                                S.current.dict_label_data_value),
                            hintText: S.current.app_label_please_input,
                            border: const UnderlineInputBorder()),
                        onChanged: (value) {
                    ...
                    MyFormBuilderTextField(
                        ...
                        decoration: MyInputDecoration(
                            floatingLabelBehavior: FloatingLabelBehavior.always,
                            labelText: S.current.dict_label_data_css_class,
                            hintText: S.current.app_label_please_input,
                            border: const UnderlineInputBorder()),
                        onChanged: (value) {
                    ...
                    MyFormBuilderTextField(
                        ...
                        decoration: MyInputDecoration(
                            floatingLabelBehavior: FloatingLabelBehavior.always,
                            labelText: S.current.dict_label_data_list_style,
                            hintText: S.current.app_label_please_input,
                            border: const UnderlineInputBorder()),
                        onChanged: (value) {
                    ...
                    MyFormBuilderTextField(
                        ...
                        decoration: MyInputDecoration(
                            floatingLabelBehavior: FloatingLabelBehavior.always,
                            label: InputDecUtils.getRequiredLabel(
                                S.current.dict_label_data_order_num),
                            hintText: S.current.app_label_please_input,
                            border: const UnderlineInputBorder()),
                        onChanged: (value) {
...
class _DictDataAddEditVm extends AppBaseVm {
  ...
  void initVm({SysDictData? dictData, String? parentType}) {
    if (this.sysDictData == null || parentType == null) {
