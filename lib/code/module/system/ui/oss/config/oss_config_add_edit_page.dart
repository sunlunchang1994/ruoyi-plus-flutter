...
class _OssConfigAddEditVm extends AppBaseVm {
  ...
  void initVm({SysOssConfig? sysOssConfig}) {
    ...
    if (sysOssConfig == null) {
      sysOssConfig = SysOssConfig();
      ITreeDict<dynamic>? statusDict = GlobalVm().dictShareVm.findDict(LocalDictLib.CODE_SYS_YES_NO_INT, LocalDictLib.KEY_SYS_YES_NO_INT_N);
      sysOssConfig.isHttps = statusDict?.tdDictValue;
      ITreeDict<dynamic>? accessPolicyDict = GlobalVm().dictShareVm.findDict(LocalDictLib.CODE_ACCESS_POLICY_TYPE, LocalDictLib.KEY_ACCESS_POLICY_TYPE_PUBLIC);
