...
abstract class RoleApiClient {
  ...
  Future<ResultEntity> getInfo(@Path("roleId") int roleId, @CancelRequest() CancelToken cancelToken);
    ...
    return _deptApiClient
        ...
        .map((event) {
          return event.toIntensify(createData: (resultEntity) {
            ...
            PageModel<Role> pageModel = PageTransformUtils.appPm2Pm(appPageModel, records: dataList);
            return pageModel;
          });
        })
