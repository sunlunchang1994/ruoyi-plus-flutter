...
class EncryptInterceptor extends Interceptor {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    ...
    if ((applyEncrypt == true || applyEncrypt == "true") &&
      ...
      String aesKey = _generateRandomString();
      //String aesKey = "11111111111111111111111111111111";
      //加密aesKey
      String encryptAes = EncryptUtil.encodeBase64(aesKey);
      dynamic rsaKeyParser = RSAKeyParser().parse(_decorationPublicKey(ApiConfig.VALUE_RSA_PUBLIC_KEY));
  ...
  ///装饰公钥
  String _decorationPublicKey(String publicKey) {
